...
namespace OmegaRace
{
    ...
    public class GameManager 
    {
        ...
        private void pUpdate()
        {
            ...
            int player2Horz = InputManager.GetAxis(INPUTAXIS.HORIZONTAL_P2);
            int player2Vert = InputManager.GetAxis(INPUTAXIS.VERTICAL_P2);
            ...
            if (InputManager.GetButtonDown(INPUTBUTTON.P2_FIRE) && (player2.MissileCount() > 0))
            {
